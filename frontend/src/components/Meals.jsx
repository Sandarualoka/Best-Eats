...
//     // Handle the logic for scheduling a meal with the selected date
...
const Food = () => {
  ...
  const handleAddToCart = () => {
    // Handle the logic for adding the selected product to the cart
    if (selectedProduct) {
  ...
  return (
    <div className="max-w-[1640px] m-auto px-4 py-12">
      ...
      <Modal open={modalOpen} onClose={handleCloseModal}>
        {/* Modal content for shopping cart */}
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
          <div className="absolute inset-0" onClick={handleCloseModal}></div>
          <div className="max-w-[400px] m-auto px-4 py-12 text-center relative">
            <h2 className="text-2xl font-bold mb-4 text-white">
      ...
      <Modal open={scheduleModalOpen} onClose={handleCloseScheduleModal}>
        {/* Modal content for scheduling a meeting */}
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
          <div
